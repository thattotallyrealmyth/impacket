...
#Section 2.2.29 FW_OS_PLATFORM_OP
class FW_OS_PLATFORM_OP(Enum):
...
#Section 2.2.32  FW_RULE_ORIGIN_TYPE
...
#Section 2.2.33 FW_ENUM_RULES_FLAGS

class FW_ENUM_RULES_FLAGS(Enum):
...
#Section 2.2.35 FW_RULE_FLAGS
class FW_RULE_FLAGS(Enum):
...
#Section 2.2.39
class FW_GLOBAL_CONFIG_IPSEC_EXEMPT_VALUES(Enum):
...
#Section 2.2.40 FW_GLOBAL_CONFIG_PRESHARED_KEY_ENCODING_VALUES
class FW_GLOBAL_CONFIG_PRESHARED_KEY_ENCODING_VALUES(IntEnum):
...
#Section 2.2.41 FW_GLOBAL_CONFIG_IPSEC_THROUGH_NAT_VALUES
class FW_GLOBAL_CONFIG_IPSEC_THROUGH_NAT_VALUES(IntEnum):
...
#Section 2.2.42 FW_GLOBAL_CONFIG
