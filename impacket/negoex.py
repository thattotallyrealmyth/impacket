...
class NegoMessage(Structure):
    ...
    def fromString(self, data):
        ...
        for i in range(0, len(extBlob), EXTENSION_SIZE):
            ...
            ext.ExtensionValue = _sliceMessageData(
                data,
                valueOffset,
                ext['ByteArrayLength'],
                'Extensions.Value',
...
class ExchangeMessage(Structure):
    ...
    def fromString(self, data):
        ...
        self['Exchange'] = _sliceMessageData(
            data,
            offset,
            self['ExchangeLength'],
            'Exchange',
...
class VerifyMessage(Structure):
    ...
    def fromString(self, data):
        ...
        self['ChecksumValue'] = _sliceMessageData(
            data,
            offset,
...
class AlertMessage(Structure):
    ...
    def fromString(self, data):
        ...
        for i in range(0, len(alertBlob), ALERT_SIZE):
            ...
            alert.AlertValue = _sliceMessageData(
                data,
                valueOffset,
                alert['ByteArrayLength'],
                'Alerts.Value',
            )
